  ...
  <div class="overview-products">
    <div class="info__wrapper">
      <div class="info__element">
        <p class="info__element-text">Всего рационов</p>
      ...
      <div class="info__element">
        <p class="info__element-text">Мои рационы</p>
        <p class="info__element-value">{{ myProductsAmount }}</p>
      </div>
    </div>
    <div class="add-product-btn__wrapper">
      <app-button sizeXL uppercase right @click.native="openModal()">Добавить рацион</app-button>
    </div>
  </div>
</template>
