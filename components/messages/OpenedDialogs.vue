<template>
  <div class="opened-dialogs">
    <app-block-title>Открытые диалоги</app-block-title>
    ...
    <ul class="opened-dialogs__chat-list">
      ...
      <li v-for="(item, index) in 4" :key="index" class="chat-list__item">
        <div class="dialog-card">
          <div class="dialog-card__header">
            <img class="header__user-avatar" src="https://pic.sport.ua/media/images/Foto%202.jpg" alt="">
            <div class="header__user-info">
      ...
      .dialog-card {
        .dialog-card__header {
          ...
          .header__user-info {
            ...
            .user-info__last-visit-or-status {
              // color: $gray;
              font-size: 12px;
              // font-weight: 500;
            }
          }
          .header__unread-message {
            // align-self: center;
            margin-left: auto;
            text-align: center;
            .unread-message__amount {
              padding: 5px;
              min-width: 30px;
              background: $green;
              border-radius: 6px;
          ...
          .header__unread-message--disable {
            visibility: hidden;
          }
        }
        .dialog-card__last-message-preview {
          display: flex;
